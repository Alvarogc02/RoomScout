...
public final class ActivityAdminInsertBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAdminInsertBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnGuardar,
      @NonNull EditText editTextNombre, @NonNull EditText editTextPrecio,
  ...
  @NonNull
  public static ActivityAdminInsertBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAdminInsertBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_admin_insert, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAdminInsertBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAdminInsertBinding((ConstraintLayout) rootView, btnGuardar, editTextNombre,
          editTextPrecio, mapLayout, toolbar, tvDireccion, tvTitle, tvUbicacion);
    }
