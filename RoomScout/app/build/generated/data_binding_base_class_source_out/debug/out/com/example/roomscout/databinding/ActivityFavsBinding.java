...
public final class ActivityFavsBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityFavsBinding(@NonNull DrawerLayout rootView, @NonNull Button btnFiltrar,
  ...
  @NonNull
  public static ActivityFavsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityFavsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_favs, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityFavsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFavsBinding((DrawerLayout) rootView, btnFiltrar, lvHoteles, navDrawer,
          navView, toolbar);
    }
