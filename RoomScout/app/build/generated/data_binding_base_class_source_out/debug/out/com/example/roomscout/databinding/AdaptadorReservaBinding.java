...
public final class AdaptadorReservaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static AdaptadorReservaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static AdaptadorReservaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.adaptador_reserva, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static AdaptadorReservaBinding bind(@NonNull View rootView) {
